  ...
  return (
    <div className="relative flex gap-4 max-xl:gap-2">
      ...
      <div className="group relative">
        ...
        {/* cart modal */}
        <div className="border-neutral3 invisible absolute top-14 left-0 rounded-xl border bg-white p-3 pr-1.5 opacity-0 transition-all delay-75 group-hover:visible group-hover:opacity-100">
          {/* header */}
