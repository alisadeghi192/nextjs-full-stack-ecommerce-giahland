export const FAQ_ITEMS = [
  {
    ...
    content:
      "بسیار ساده. کافی است از گیاه خود چند عکس واضح (از نمای کلی برگ‌ها، ساقه، زیر برگ‌ها و خاک) بگیرید و از طریق بخش «مشاوره گیاه‌پزشکی» در پنل کاربری خود ارسال کنید. تیم ما ظرف حداکثر ۲۴ ساعت نظر تخصصی خود را همراه با نسخه درمانی به شما ارائه می‌دهد.",
  },
  {
    id: "2",
    title: "خدمات گیاه‌پزشکی شما رایگان است یا هزینه دارد؟",
    content:
      "مشاوره اولیه و تشخیص مقدماتی بیماری با پرداخت ویزیت انجام می‌شود. در صورت نیاز به معاینه دقیق‌تر، آزمایش خاک، یا ویزیت حضوری (در شهر تهران)، هزینه جداگانه و شفافی اعمال می‌شود که پیش از انجام خدمت به اطلاع شما می‌رسد.",
  },
  {
    id: "3",
