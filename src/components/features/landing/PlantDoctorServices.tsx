...
export default function PlantDoctorServices() {
  const plantDoctorServices = [
    ...
    },
    {
      ...
      description: "یکی از موارد مهم خاک، مقدار مواد معدنی آن است که با دقت برسی می‌شود.",
    },
    {
    ...
    },
    {
      ...
      icon: RiTreeFill ,
      description: "با استفاده از روش های نوین،عناصر آلوده از خاک گیاهان شما جمع آوری می‌شوند.",
    },
    {
      title: "برسی ظاهر",
      icon: RiFlowerFill  ,
      description: "ظاهر گیاه بیانگر مسائل مهمی هست.می‌توان با مشاهده ظاهر گیاه متوجه آفات و ... شد.",
    },
    {
